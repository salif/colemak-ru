...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [русский](LINUX.ru.md), [中文](LINUX.zh-CN.md), [español](LINUX.es.md), [português](LINUX.pt.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)</span>
...
افتح الملف `/usr/share/X11/xkb/symbols/ru` وقم بإلحاق الكتلة النصية التالية في نهاية الملف
...
افتح الملف `/usr/share/X11/xkb/rules/evdev.xml` وأدخل الكتلة النصية التالية بعد `Russian (typewriter)` variant.
...
ثم أضف `Russian (Colemak)` من خلال إعدادات بيئة سطح المكتب لديك.
