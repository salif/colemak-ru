...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [русский](LINUX.ru.md), [中文](LINUX.zh-CN.md), [العربية](LINUX.ar.md), [português](LINUX.pt.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)</span>
...
Abrir documento `/usr/share/X11/xkb/symbols/ru` y agregue el siguiente bloque de texto al final del archivo
...
Abrir documento `/usr/share/X11/xkb/rules/evdev.xml` e inserte el siguiente bloque de texto después de `Russian (typewriter)` variant.
...
Luego añade `Russian (Colemak)` a través de la configuración de su entorno de escritorio.
