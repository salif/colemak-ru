...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [русский](LINUX.ru.md), [中文](LINUX.zh-CN.md), [español](LINUX.es.md), [العربية](LINUX.ar.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)</span>
...
Abrir arquivo `/usr/share/X11/xkb/symbols/ru` e anexe o seguinte bloco de texto no final do arquivo
...
Abrir arquivo `/usr/share/X11/xkb/rules/evdev.xml` e insira o seguinte bloco de texto após o `Russian (typewriter)` variant.
...
Em seguida, adicione `Russian (Colemak)` através das configurações do seu ambiente de trabalho.
