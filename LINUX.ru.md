...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [中文](LINUX.zh-CN.md), [español](LINUX.es.md), [العربية](LINUX.ar.md), [português](LINUX.pt.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)</span>
...
Открыть файл `/usr/share/X11/xkb/symbols/ru` и добавьте следующий текстовый блок в конец файла
...
Открыть файл `/usr/share/X11/xkb/rules/evdev.xml` и вставьте следующий текстовый блок после `Russian (typewriter)` variant.
...
Затем добавьте `Russian (Colemak)` через настройки среды рабочего стола.
