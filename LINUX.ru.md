...
Перевод: [english](LINUX.md), [中文](LINUX.zh-CN.md), [español](LINUX.es.md), [العربية](LINUX.ar.md), [português](LINUX.pt.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)
...
**2.** Открыть файл `/usr/share/X11/xkb/symbols/ru` и добавьте следующий текстовый блок в конец файла:
...
**3.** Открыть файл `/usr/share/X11/xkb/rules/evdev.xml` и вставьте следующий текстовый блок после варианта `Russian (typewriter)`:
...
**4.** Затем добавьте `Russian (Colemak)` через настройки среды рабочего стола.
