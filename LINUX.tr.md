...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [русский](LINUX.ru.md), [中文](LINUX.zh-CN.md), [español](LINUX.es.md), [العربية](LINUX.ar.md), [português](LINUX.pt.md), [bahasa](LINUX.id.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)</span>
...
Açık dosya `/usr/share/X11/xkb/rules/evdev.xml` ve ardından aşağıdaki metin bloğunu ekleyin `Russian (typewriter)` variant.
