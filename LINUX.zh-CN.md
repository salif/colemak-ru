...
points="15,19 21,19 23,23 18,11 13,23 " /></svg> : [english](LINUX.md), [русский](LINUX.ru.md), [español](LINUX.es.md), [العربية](LINUX.ar.md), [português](LINUX.pt.md), [bahasa](LINUX.id.md), [türkçe](LINUX.tr.md), [български](LINUX.bg.md), [esperanto](LINUX.eo.md)</span>
...
打开文件 `/usr/share/X11/xkb/symbols/ru` 并将以下文本块附加到文件末尾
...
打开文件 `/usr/share/X11/xkb/rules/evdev.xml` 并在后面插入以下文本块 `Russian (typewriter)` variant.
